...
import { cancelSalesReturnAction } from "@/app/actions/returns";

export function CancelSalesReturnButton({ returnId, invoiceId }: { returnId: string; invoiceId: string }) {
  ...
  function submit() {
    ...
    startTransition(async () => {
      const res = await cancelSalesReturnAction(returnId, invoiceId, reason);
