...
import { cancelDeliveryChallanAction } from "@/app/actions/deliveryChallans";

export function CancelDeliveryChallanButton({ dcId }: { dcId: string }) {
  ...
  function submit() {
    ...
    startTransition(async () => {
      const res = await cancelDeliveryChallanAction(dcId, reason);
