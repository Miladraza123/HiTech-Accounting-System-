...
import { cancelPurchaseReturnAction } from "@/app/actions/returns";

export function CancelPurchaseReturnButton({ returnId, supplierBillId }: { returnId: string; supplierBillId: string }) {
  ...
  function submit() {
    ...
    startTransition(async () => {
      const res = await cancelPurchaseReturnAction(returnId, supplierBillId, reason);
