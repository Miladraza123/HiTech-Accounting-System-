...
export default async function ExpensesPage({ searchParams }: { searchParams: Promise<{ page?: string }> }) {
  ...
  return (
    <div className="space-y-6">
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {expenses.map((e) => {
                  ...
                  return (
                    <tr key={e.id} className="border-t border-line even:bg-bg hover:bg-surface-2">
      ...
      <PaginationControls basePath="/expenses" searchParams={{}} currentPage={page} totalPages={totalPages} totalCount={count ?? 0} />
    </div>
  );
}
